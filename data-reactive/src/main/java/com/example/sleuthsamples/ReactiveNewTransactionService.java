...
public class ReactiveNewTransactionService {
	...
	public ReactiveNewTransactionService(ReactiveCustomerRepository repository, ReactiveContinuedTransactionService reactiveContinuedTransactionService, Tracer tracer) {
	...
	public Mono<Void> newTransaction() {
		return Mono.fromRunnable(() -> log.info("<ACCEPTANCE_TEST> <TRACE:{}> Hello from producer", tracer.currentSpan().context().traceId()))
